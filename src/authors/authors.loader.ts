...
import { AuthorModel as PrismaAuthor, BookModel as PrismaBook } from '../generated/prisma/models.cjs';
...
export class AuthorsLoader {
  ...
  public readonly authorLoader = new DataLoader<number, PrismaAuthor | null>(async (ids) => {
  ...
  public readonly booksByAuthorLoader = new DataLoader<number, PrismaBook[]>(async (authorIds) => {
